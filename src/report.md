...
![ssh](misc/images/8.1.png)

- Перенастроить службу SSHd на порт 2022
![ssh](misc/images/8.2.png)
...
## Part 9. Установка и использование утилит **top**, **htop**
  ...
  ![PID](misc/images/9.1.png)
  - PERCENT_CPU
  ![PERCENT_CPU](misc/images/9.2.png)
  - PERCENT_MEM
  ![PERCENT_MEM](misc/images/9.2.png)
  - TIME
  ![TIME](misc/images/9.4.png)
  - отфильтрованный для процесса sshd
  ![sshd](misc/images/9.5.png)
...
3. размер папки /var
 ![ncdu /var](misc/images/13.3.png)
4. размер папки /var/log
 ![ncdu /var/log](misc/images/13.4.png)
